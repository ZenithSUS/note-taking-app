  ...
  return (
    <div className="hidden flex-col h-screen sm:block p-4 bg-gray-900 text-white w-64 absolute top-0 left-0 border-r z-10">
      ...
      <ul className="space-y-2 text-1xl">
        <li>
          <Link to="/dashboard" className="block py-2 p-2 hover:bg-gray-700">
            Dashboard
          </Link>
        </li>
        <li>
          <Link to="/notes" className="block py-2 p-2 hover:bg-gray-700">
            Notes
          </Link>
        </li>
        <li>
          <Link to="/settings" className="block py-2 p-2 hover:bg-gray-700">
            Settings
          </Link>
        </li>
      </ul>
